...
# add third so
#RUN mkdir -p /kingdee/so
#COPY so/* /kingdee/so/
#RUN chmod 777 /kingdee/so/*

ENV LD_LIBRARY_PATH=$LD_LIBRARY_PATH:/kingdee/webapp/root\\\$${app}/$app/WEB-INF/res
ENV PATH=$PATH:/kingdee/webapp/root\\\$${app}/$app/WEB-INF/res
...
## add res +x
RUN chmod 777 /kingdee/webapp/root\\\$${app}/$app/WEB-INF/res/*
EOF
